...
from ..helpers import DB, Config, exists, format_exc, str_exc, parse_html_header
...
class BasePlugin:
    ...
    def load(
        ...
        header = http_req.response_headers.with_set_many({"code": req.code, "url": req.last_effective_url})
